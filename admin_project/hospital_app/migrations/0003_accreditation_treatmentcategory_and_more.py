# Generated by Django 5.2.4 on 2025-07-24 04:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('accreditation_type', models.CharField(choices=[('national', 'National'), ('international', 'International'), ('state', 'State'), ('specialty', 'Specialty'), ('quality', 'Quality')], default='national', max_length=20)),
                ...
                ('status', models.CharField(choices=[('active', 'Active'), ('expired', 'Expired'), ('pending', 'Pending'), ('suspended', 'Suspended'), ('revoked', 'Revoked')], default='active', max_length=20)),
