...
class Specialization(models.Model):
    name = models.CharField(max_length=100)
    icon = models.ForeignKey(SpecializationIcon, on_delete=models.SET_NULL, null=True, blank=True)
...
class Doctor(models.Model):
    ...
    specialization = models.ForeignKey('hospital_app.Specialty', on_delete=models.SET_NULL, null=True)
    ...
    icon = models.ImageField(upload_to='doctor_icons/', blank=True, null=True)
